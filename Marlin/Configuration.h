...
#define STRING_VERSION_CONFIG_H "2013-12-27" //Personal revision number for changes to THIS file.
#define STRING_CONFIG_H_AUTHOR "jeremybennett" //Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {71.1, 71.1, 2560, 691.32} // Embecosm TVRR
